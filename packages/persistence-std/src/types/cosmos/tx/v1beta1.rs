...
pub mod mode_info {
    ...
    pub struct Single {
        ...
        #[serde(
            serialize_with = "super::super::signing::v1beta1::sign_mode_serde::serialize",
            deserialize_with = "super::super::signing::v1beta1::sign_mode_serde::deserialize"
        )]
        pub mode: i32,
    }
...
pub struct AuxSignerData {
    ...
    #[serde(
        serialize_with = "super::signing::v1beta1::sign_mode_serde::serialize",
        deserialize_with = "super::signing::v1beta1::sign_mode_serde::deserialize"
    )]
    pub mode: i32,
...
pub struct GetTxsEventRequest {
    ...
    #[serde(
        serialize_with = "order_by_serde::serialize",
        deserialize_with = "order_by_serde::deserialize"
    )]
    pub order_by: i32,
...
pub struct BroadcastTxRequest {
    ...
    #[serde(
        serialize_with = "broadcast_mode_serde::serialize",
        deserialize_with = "broadcast_mode_serde::deserialize"
    )]
    pub mode: i32,
}
...
pub mod order_by_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        let enum_value = OrderBy::from_str_name(&s).unwrap();
    ...
    where
        S: Serializer,
    {
        let s: OrderBy = OrderBy::from_i32(*value).unwrap();
...
pub mod broadcast_mode_serde {
    use super::BroadcastMode;
    use serde::{Deserialize, Deserializer, Serializer};
    pub fn deserialize<'de, T, D>(deserializer: D) -> std::result::Result<T, D::Error>
    where
        T: From<BroadcastMode>,
        D: Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        let enum_value = BroadcastMode::from_str_name(&s).unwrap();
        let int_value: T = enum_value.into();
        return Ok(int_value);
    }
    pub fn serialize<S>(value: &i32, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let s: BroadcastMode = BroadcastMode::from_i32(*value).unwrap();
        serializer.serialize_str(s.as_str_name())
    }
}
impl BroadcastMode {
