...
pub mod signature_descriptor {
    ...
    pub mod data {
        ...
        pub struct Single {
            ...
            #[serde(
                serialize_with = "super::super::sign_mode_serde::serialize",
                deserialize_with = "super::super::sign_mode_serde::deserialize"
            )]
            pub mode: i32,
...
pub mod sign_mode_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        let enum_value = SignMode::from_str_name(&s).unwrap();
    ...
    where
        S: Serializer,
    {
        let s: SignMode = SignMode::from_i32(*value).unwrap();
