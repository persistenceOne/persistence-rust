...
impl<'de> serde::Deserialize<'de> for Deposit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.Deposit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DepositParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.DepositParams", len)?;
        if !self.min_deposit.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<DepositParams, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::MaxDepositPeriod => {
                            if max_deposit_period__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("maxDepositPeriod"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.DepositParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.GenesisState", len)?;
        if self.starting_proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "startingProposalId",
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "depositParams" | "deposit_params" => {
                                Ok(GeneratedField::DepositParams)
                            }
                            "votingParams" | "voting_params" => {
                                Ok(GeneratedField::VotingParams)
                            }
                            "tallyParams" | "tally_params" => {
                                Ok(GeneratedField::TallyParams)
                            }
                    ...
                    match k {
                        GeneratedField::StartingProposalId => {
                            if starting_proposal_id__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("startingProposalId"),
                                );
                            }
                        ...
                        GeneratedField::DepositParams => {
                            if deposit_params__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("depositParams"),
                                );
                            }
                        ...
                        GeneratedField::VotingParams => {
                            if voting_params__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("votingParams"),
                                );
                            }
                        ...
                        GeneratedField::TallyParams => {
                            if tally_params__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("tallyParams"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgDeposit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgDeposit", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgDeposit, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut proposal_id__ = None;
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.MsgDeposit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgDepositResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgDepositResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgExecLegacyContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgExecLegacyContent", len)?;
...
impl serde::Serialize for MsgExecLegacyContentResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgExecLegacyContentResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgSubmitProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgSubmitProposal", len)?;
        if !self.messages.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgSubmitProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::InitialDeposit => {
                            if initial_deposit__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("initialDeposit"),
                                );
                            }
...
impl serde::Serialize for MsgSubmitProposalResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgSubmitProposalResponse", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for MsgUpdateParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgUpdateParams", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if let Some(v) = self.params.as_ref() {
...
impl serde::Serialize for MsgUpdateParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgUpdateParamsResponse", len)?;
        struct_ser.end()
    }
}
        ...
        if self.option != 0 {
            let v = VoteOption::from_i32(self.option)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.option),
                ))?;
...
impl<'de> serde::Deserialize<'de> for MsgVote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.MsgVote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgVoteResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgVoteResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgVoteResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl serde::Serialize for MsgVoteWeighted {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgVoteWeighted", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgVoteWeighted, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut proposal_id__ = None;
...
impl serde::Serialize for MsgVoteWeightedResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.MsgVoteWeightedResponse", len)?;
        struct_ser.end()
    }
}
        ...
        if !self.min_initial_deposit_ratio.is_empty() {
            struct_ser
                .serialize_field(
                    ...
                    &self.min_initial_deposit_ratio,
                )?;
        }
        if self.burn_vote_quorum {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "burnVoteVeto" | "burn_vote_veto" => {
                                Ok(GeneratedField::BurnVoteVeto)
                            }
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::VotingPeriod => {
                            if voting_period__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("votingPeriod"),
                                );
                            }
                        ...
                        GeneratedField::VetoThreshold => {
                            if veto_threshold__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("vetoThreshold"),
                                );
                            }
                        ...
                        GeneratedField::MinInitialDepositRatio => {
                            if min_initial_deposit_ratio__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("minInitialDepositRatio"),
                                );
                            }
                        ...
                        GeneratedField::BurnVoteQuorum => {
                            if burn_vote_quorum__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("burnVoteQuorum"),
                                );
                            }
                        ...
                        GeneratedField::BurnVoteVeto => {
                            if burn_vote_veto__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("burnVoteVeto"),
                                );
                            }
                ...
                Ok(Params {
                    ...
                    min_initial_deposit_ratio: min_initial_deposit_ratio__
                        .unwrap_or_default(),
...
impl<'de> serde::Deserialize<'de> for Proposal {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "submitTime" | "submit_time" => {
                                Ok(GeneratedField::SubmitTime)
                            }
                            "depositEndTime" | "deposit_end_time" => {
                                Ok(GeneratedField::DepositEndTime)
                            }
                            "totalDeposit" | "total_deposit" => {
                                Ok(GeneratedField::TotalDeposit)
                            }
                    ...
                    match k {
                        ...
                        GeneratedField::FinalTallyResult => {
                            if final_tally_result__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("finalTallyResult"),
                                );
                            }
                        ...
                        GeneratedField::DepositEndTime => {
                            if deposit_end_time__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("depositEndTime"),
                                );
                            }
                        ...
                        GeneratedField::TotalDeposit => {
                            if total_deposit__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("totalDeposit"),
                                );
                            }
                        ...
                        GeneratedField::VotingStartTime => {
                            if voting_start_time__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("votingStartTime"),
                                );
                            }
                        ...
                        GeneratedField::VotingEndTime => {
                            if voting_end_time__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("votingEndTime"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.Proposal", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for QueryDepositRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryDepositRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryDepositRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut proposal_id__ = None;
...
impl serde::Serialize for QueryDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryDepositResponse", len)?;
...
impl serde::Serialize for QueryDepositsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryDepositsRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryDepositsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryDepositsResponse", len)?;
        if !self.deposits.is_empty() {
            struct_ser.serialize_field("deposits", &self.deposits)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryParamsRequest", len)?;
        if !self.params_type.is_empty() {
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryParamsResponse", len)?;
        if let Some(v) = self.voting_params.as_ref() {
            struct_ser.serialize_field("votingParams", v)?;
        }
        if let Some(v) = self.deposit_params.as_ref() {
...
impl serde::Serialize for QueryProposalRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryProposalRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryProposalResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryProposalResponse", len)?;
...
impl serde::Serialize for QueryProposalsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryProposalsRequest", len)?;
        if self.proposal_status != 0 {
            let v = ProposalStatus::from_i32(self.proposal_status)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.proposal_status),
                ))?;
                    ...
                    match k {
                        GeneratedField::ProposalStatus => {
                            if proposal_status__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("proposalStatus"),
                                );
                            }
                            proposal_status__ = Some(
                                map.next_value::<ProposalStatus>()? as i32,
                            );
                        }
                        GeneratedField::Voter => {
                            if voter__.is_some() {
...
impl serde::Serialize for QueryProposalsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryProposalsResponse", len)?;
        if !self.proposals.is_empty() {
            struct_ser.serialize_field("proposals", &self.proposals)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryTallyResultRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryTallyResultRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryTallyResultResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryTallyResultResponse", len)?;
...
impl serde::Serialize for QueryVoteRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryVoteRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryVoteRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut proposal_id__ = None;
...
impl serde::Serialize for QueryVoteResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryVoteResponse", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryVoteResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut vote__ = None;
...
impl serde::Serialize for QueryVotesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryVotesRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryVotesRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut proposal_id__ = None;
...
impl serde::Serialize for QueryVotesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.QueryVotesResponse", len)?;
        if !self.votes.is_empty() {
            struct_ser.serialize_field("votes", &self.votes)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryVotesResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut votes__ = None;
...
impl serde::Serialize for TallyParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.TallyParams", len)?;
        if !self.quorum.is_empty() {
            struct_ser.serialize_field("quorum", &self.quorum)?;
        }
        if !self.threshold.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<TallyParams, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut quorum__ = None;
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.TallyParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TallyResult {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.TallyResult", len)?;
        if !self.yes_count.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "abstainCount" | "abstain_count" => {
                                Ok(GeneratedField::AbstainCount)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<TallyResult, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::AbstainCount => {
                            if abstain_count__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("abstainCount"),
                                );
                            }
                        ...
                        GeneratedField::NoWithVetoCount => {
                            if no_with_veto_count__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("noWithVetoCount"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.TallyResult", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for VotingParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.VotingParams", len)?;
        if let Some(v) = self.voting_period.as_ref() {
            struct_ser.serialize_field("votingPeriod", v)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<VotingParams, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut voting_period__ = None;
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1.VotingParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WeightedVoteOption {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1.WeightedVoteOption", len)?;
        if self.option != 0 {
            let v = VoteOption::from_i32(self.option)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.option),
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<WeightedVoteOption, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut option__ = None;
