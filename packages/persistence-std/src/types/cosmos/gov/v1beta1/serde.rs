impl serde::Serialize for Deposit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.Deposit", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl<'de> serde::Deserialize<'de> for Deposit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1beta1.Deposit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DepositParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.DepositParams", len)?;
        if !self.min_deposit.is_empty() {
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.GenesisState", len)?;
        if self.starting_proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "startingProposalId",
...
impl serde::Serialize for MsgDeposit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgDeposit", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for MsgDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgDepositResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgSubmitProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgSubmitProposal", len)?;
...
impl serde::Serialize for MsgSubmitProposalResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgSubmitProposalResponse", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.gov.v1beta1.MsgSubmitProposalResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for MsgVote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgVote", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl<'de> serde::Deserialize<'de> for MsgVote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1beta1.MsgVote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgVoteResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgVoteResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgVoteWeighted {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgVoteWeighted", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for MsgVoteWeightedResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.MsgVoteWeightedResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for Proposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.Proposal", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl<'de> serde::Deserialize<'de> for Proposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1beta1.Proposal", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for QueryDepositRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryDepositRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryDepositResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryDepositResponse", len)?;
...
impl serde::Serialize for QueryDepositsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryDepositsRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryDepositsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryDepositsResponse", len)?;
        if !self.deposits.is_empty() {
            struct_ser.serialize_field("deposits", &self.deposits)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryParamsRequest", len)?;
        if !self.params_type.is_empty() {
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryParamsResponse", len)?;
        if let Some(v) = self.voting_params.as_ref() {
            struct_ser.serialize_field("votingParams", v)?;
        }
        if let Some(v) = self.deposit_params.as_ref() {
...
impl serde::Serialize for QueryProposalRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryProposalRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryProposalResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryProposalResponse", len)?;
...
impl serde::Serialize for QueryProposalsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryProposalsRequest", len)?;
        if self.proposal_status != 0 {
...
impl serde::Serialize for QueryProposalsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryProposalsResponse", len)?;
        if !self.proposals.is_empty() {
            struct_ser.serialize_field("proposals", &self.proposals)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryTallyResultRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryTallyResultRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryTallyResultResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryTallyResultResponse", len)?;
...
impl serde::Serialize for QueryVoteRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryVoteRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryVoteResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryVoteResponse", len)?;
...
impl serde::Serialize for QueryVotesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryVotesRequest", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl serde::Serialize for QueryVotesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.QueryVotesResponse", len)?;
        if !self.votes.is_empty() {
            struct_ser.serialize_field("votes", &self.votes)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for TallyParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.TallyParams", len)?;
        if !self.quorum.is_empty() {
            struct_ser
                .serialize_field(
                    "quorum",
...
impl serde::Serialize for TallyResult {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.TallyResult", len)?;
        if !self.yes.is_empty() {
...
impl serde::Serialize for TextProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.TextProposal", len)?;
        if !self.title.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<TextProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for Vote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.Vote", len)?;
        if self.proposal_id != 0 {
            struct_ser
                .serialize_field(
                    "proposalId",
...
impl<'de> serde::Deserialize<'de> for Vote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.gov.v1beta1.Vote", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for VotingParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.VotingParams", len)?;
...
impl serde::Serialize for WeightedVoteOption {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.v1beta1.WeightedVoteOption", len)?;
        if self.option != 0 {
            let v = VoteOption::from_i32(self.option)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.option),
