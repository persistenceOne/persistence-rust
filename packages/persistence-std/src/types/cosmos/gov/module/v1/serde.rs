impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.gov.module.v1.Module", len)?;
        if self.max_metadata_len != 0 {
            struct_ser
                .serialize_field(
                    "maxMetadataLen",
...
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
                    ...
                    match k {
                        GeneratedField::MaxMetadataLen => {
                            if max_metadata_len__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("maxMetadataLen"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.gov.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
