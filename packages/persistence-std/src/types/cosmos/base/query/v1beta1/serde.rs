impl serde::Serialize for PageRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.query.v1beta1.PageRequest", len)?;
        if !self.key.is_empty() {
            struct_ser
                .serialize_field(
                    "key",
        ...
        if self.offset != 0 {
            struct_ser
                .serialize_field("offset", ToString::to_string(&self.offset).as_str())?;
        }
        if self.limit != 0 {
            struct_ser
                .serialize_field("limit", ToString::to_string(&self.limit).as_str())?;
        }
        if self.count_total {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<PageRequest, V::Error>
            where
...
impl serde::Serialize for PageResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.query.v1beta1.PageResponse", len)?;
        if !self.next_key.is_empty() {
            struct_ser
                .serialize_field(
                    "nextKey",
        ...
        if self.total != 0 {
            struct_ser
                .serialize_field("total", ToString::to_string(&self.total).as_str())?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<PageResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
