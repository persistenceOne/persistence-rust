impl serde::Serialize for Coin {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.v1beta1.Coin", len)?;
        if !self.denom.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Coin {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.base.v1beta1.Coin", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DecCoin {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.v1beta1.DecCoin", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        if !self.amount.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DecCoin {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.base.v1beta1.DecCoin", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DecProto {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.v1beta1.DecProto", len)?;
        if !self.dec.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DecProto {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.base.v1beta1.DecProto", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IntProto {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.v1beta1.IntProto", len)?;
        if !self.int.is_empty() {
...
impl<'de> serde::Deserialize<'de> for IntProto {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.base.v1beta1.IntProto", FIELDS, GeneratedVisitor)
    }
}
