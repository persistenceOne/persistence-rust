impl serde::Serialize for ConfigRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.base.node.v1beta1.ConfigRequest", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ConfigRequest, V::Error>
            where
...
impl serde::Serialize for ConfigResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.base.node.v1beta1.ConfigResponse", len)?;
        if !self.minimum_gas_price.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ConfigResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        GeneratedField::MinimumGasPrice => {
                            if minimum_gas_price__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("minimumGasPrice"),
                                );
                            }
