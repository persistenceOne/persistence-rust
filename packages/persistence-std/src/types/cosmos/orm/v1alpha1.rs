...
pub mod module_schema_descriptor {
    ...
    pub struct FileEntry {
        ...
        #[serde(
            serialize_with = "super::storage_type_serde::serialize",
            deserialize_with = "super::storage_type_serde::deserialize"
        )]
...
pub mod storage_type_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        let enum_value = StorageType::from_str_name(&s).unwrap();
    ...
    where
        S: Serializer,
    {
        let s: StorageType = StorageType::from_i32(*value).unwrap();
