impl serde::Serialize for AddressBytesToStringRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.AddressBytesToStringRequest", len)?;
        if !self.address_bytes.is_empty() {
            struct_ser
                .serialize_field(
                    "addressBytes",
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "addressBytes" | "address_bytes" => {
                                Ok(GeneratedField::AddressBytes)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.AddressBytesToStringRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        GeneratedField::AddressBytes => {
                            if address_bytes__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("addressBytes"),
                                );
                            }
...
impl serde::Serialize for AddressBytesToStringResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.AddressBytesToStringResponse", len)?;
        if !self.address_string.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "addressString" | "address_string" => {
                                Ok(GeneratedField::AddressString)
                            }
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.AddressBytesToStringResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        GeneratedField::AddressString => {
                            if address_string__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("addressString"),
                                );
                            }
...
impl serde::Serialize for AddressStringToBytesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.AddressStringToBytesRequest", len)?;
        if !self.address_string.is_empty() {
            struct_ser.serialize_field("addressString", &self.address_string)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.AddressStringToBytesRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for AddressStringToBytesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.AddressStringToBytesResponse", len)?;
        if !self.address_bytes.is_empty() {
            struct_ser
                .serialize_field(
                    "addressBytes",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.AddressStringToBytesResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for BaseAccount {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.BaseAccount", len)?;
        if !self.address.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "accountNumber" | "account_number" => {
                                Ok(GeneratedField::AccountNumber)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<BaseAccount, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::AccountNumber => {
                            if account_number__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("accountNumber"),
                                );
                            }
...
impl serde::Serialize for Bech32PrefixRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.Bech32PrefixRequest", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<Bech32PrefixRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for Bech32PrefixResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.Bech32PrefixResponse", len)?;
        if !self.bech32_prefix.is_empty() {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "bech32Prefix" | "bech32_prefix" => {
                                Ok(GeneratedField::Bech32Prefix)
                            }
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                    ...
                    match k {
                        GeneratedField::Bech32Prefix => {
                            if bech32_prefix__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("bech32Prefix"),
                                );
                            }
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.GenesisState", len)?;
...
impl serde::Serialize for ModuleAccount {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.ModuleAccount", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ModuleAccount, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        GeneratedField::BaseAccount => {
                            if base_account__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("baseAccount"),
                                );
                            }
                        ...
                        GeneratedField::Permissions => {
                            if permissions__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("permissions"),
                                );
                            }
...
impl serde::Serialize for ModuleCredential {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.ModuleCredential", len)?;
        if !self.module_name.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ModuleCredential, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::DerivationKeys => {
                            if derivation_keys__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("derivationKeys"),
                                );
                            }
...
impl serde::Serialize for MsgUpdateParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.MsgUpdateParams", len)?;
        if !self.authority.is_empty() {
...
impl serde::Serialize for MsgUpdateParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.MsgUpdateParamsResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.Params", len)?;
        if self.max_memo_characters != 0 {
            struct_ser
                .serialize_field(
                    "maxMemoCharacters",
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        GeneratedField::MaxMemoCharacters => {
                            if max_memo_characters__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("maxMemoCharacters"),
                                );
                            }
                        ...
                        GeneratedField::TxSizeCostPerByte => {
                            if tx_size_cost_per_byte__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("txSizeCostPerByte"),
                                );
                            }
                        ...
                        GeneratedField::SigVerifyCostEd25519 => {
                            if sig_verify_cost_ed25519__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("sigVerifyCostEd25519"),
                                );
                            }
                        ...
                        GeneratedField::SigVerifyCostSecp256k1 => {
                            if sig_verify_cost_secp256k1__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("sigVerifyCostSecp256k1"),
                                );
                            }
                ...
                Ok(Params {
                    ...
                    sig_verify_cost_ed25519: sig_verify_cost_ed25519__
                        .unwrap_or_default(),
                    sig_verify_cost_secp256k1: sig_verify_cost_secp256k1__
                        .unwrap_or_default(),
                })
            }
        }
        deserializer
            .deserialize_struct("cosmos.auth.v1beta1.Params", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if self.account_id != 0 {
            struct_ser
                .serialize_field(
                    "accountId",
                    ToString::to_string(&self.account_id).as_str(),
                )?;
        }
        struct_ser.end()
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.auth.v1beta1.QueryAccountAddressByIDRequest",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.auth.v1beta1.QueryAccountAddressByIDResponse",
                    )
            }
            fn visit_map<V>(
                self,
                    ...
                    match k {
                        GeneratedField::AccountAddress => {
                            if account_address__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("accountAddress"),
                                );
                            }
...
impl serde::Serialize for QueryAccountInfoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountInfoRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryAccountInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountInfoResponse", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.QueryAccountInfoResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryAccountRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryAccountRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
...
impl serde::Serialize for QueryAccountResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountResponse", len)?;
...
impl serde::Serialize for QueryAccountsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountsRequest", len)?;
...
impl serde::Serialize for QueryAccountsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryAccountsResponse", len)?;
        if !self.accounts.is_empty() {
            struct_ser.serialize_field("accounts", &self.accounts)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.auth.v1beta1.QueryModuleAccountByNameRequest",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.auth.v1beta1.QueryModuleAccountByNameResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for QueryModuleAccountsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryModuleAccountsRequest", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.QueryModuleAccountsRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryModuleAccountsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryModuleAccountsResponse", len)?;
        if !self.accounts.is_empty() {
            struct_ser.serialize_field("accounts", &self.accounts)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.v1beta1.QueryModuleAccountsResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryParamsRequest", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.v1beta1.QueryParamsResponse", len)?;
        if let Some(v) = self.params.as_ref() {
            struct_ser.serialize_field("params", v)?;
        }
        struct_ser.end()
