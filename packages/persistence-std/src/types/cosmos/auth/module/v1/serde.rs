impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.module.v1.Module", len)?;
        if !self.bech32_prefix.is_empty() {
        ...
        if !self.module_account_permissions.is_empty() {
            struct_ser
                .serialize_field(
                    ...
                    &self.module_account_permissions,
                )?;
        }
        if !self.authority.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(Module {
                    ...
                    module_account_permissions: module_account_permissions__
                        .unwrap_or_default(),
        ...
        deserializer
            .deserialize_struct("cosmos.auth.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ModuleAccountPermission {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.auth.module.v1.ModuleAccountPermission", len)?;
        if !self.account.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.auth.module.v1.ModuleAccountPermission")
            }
            fn visit_map<V>(
                self,
                mut map: V,
