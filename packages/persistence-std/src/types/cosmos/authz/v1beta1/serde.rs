impl serde::Serialize for EventGrant {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.EventGrant", len)?;
        if !self.msg_type_url.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<EventGrant, V::Error>
            where
...
impl serde::Serialize for EventRevoke {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.EventRevoke", len)?;
        if !self.msg_type_url.is_empty() {
            struct_ser.serialize_field("msgTypeUrl", &self.msg_type_url)?;
        }
        if !self.granter.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<EventRevoke, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut msg_type_url__ = None;
...
impl serde::Serialize for GenericAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.GenericAuthorization", len)?;
        if !self.msg.is_empty() {
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.GenesisState", len)?;
        if !self.authorization.is_empty() {
                    ...
                    match k {
                        GeneratedField::Authorization => {
                            if authorization__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("authorization"),
                                );
                            }
...
impl serde::Serialize for Grant {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.Grant", len)?;
...
impl<'de> serde::Deserialize<'de> for Grant {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.authz.v1beta1.Grant", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GrantAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.GrantAuthorization", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<GrantAuthorization, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut granter__ = None;
...
impl serde::Serialize for GrantQueueItem {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.GrantQueueItem", len)?;
        if !self.msg_type_urls.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<GrantQueueItem, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        GeneratedField::MsgTypeUrls => {
                            if msg_type_urls__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("msgTypeUrls"),
                                );
                            }
...
impl serde::Serialize for MsgExec {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgExec", len)?;
        if !self.grantee.is_empty() {
            struct_ser.serialize_field("grantee", &self.grantee)?;
        }
        if !self.msgs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgExec {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.authz.v1beta1.MsgExec", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgExecResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgExecResponse", len)?;
        if !self.results.is_empty() {
            struct_ser
                .serialize_field(
                    "results",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgExecResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgGrant {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgGrant", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
...
impl serde::Serialize for MsgGrantResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgGrantResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgGrantResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgRevoke {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgRevoke", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
...
impl serde::Serialize for MsgRevokeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.MsgRevokeResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgRevokeResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl serde::Serialize for QueryGranteeGrantsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGranteeGrantsRequest", len)?;
        if !self.grantee.is_empty() {
            struct_ser.serialize_field("grantee", &self.grantee)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.authz.v1beta1.QueryGranteeGrantsRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryGranteeGrantsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGranteeGrantsResponse", len)?;
        if !self.grants.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.authz.v1beta1.QueryGranteeGrantsResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryGranterGrantsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGranterGrantsRequest", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.authz.v1beta1.QueryGranterGrantsRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryGranterGrantsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGranterGrantsResponse", len)?;
        if !self.grants.is_empty() {
            struct_ser.serialize_field("grants", &self.grants)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.authz.v1beta1.QueryGranterGrantsResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryGrantsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGrantsRequest", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryGrantsRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut granter__ = None;
...
impl serde::Serialize for QueryGrantsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.authz.v1beta1.QueryGrantsResponse", len)?;
        if !self.grants.is_empty() {
            struct_ser.serialize_field("grants", &self.grants)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryGrantsResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut grants__ = None;
