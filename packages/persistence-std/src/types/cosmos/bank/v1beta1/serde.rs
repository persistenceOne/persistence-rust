impl serde::Serialize for Balance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Balance", len)?;
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Balance {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Balance", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DenomOwner {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.DenomOwner", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<DenomOwner, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
...
impl serde::Serialize for DenomUnit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.DenomUnit", len)?;
        if !self.denom.is_empty() {
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.GenesisState", len)?;
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "denomMetadata" | "denom_metadata" => {
                                Ok(GeneratedField::DenomMetadata)
                            }
                            "sendEnabled" | "send_enabled" => {
                                Ok(GeneratedField::SendEnabled)
                            }
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                    ...
                    match k {
                        ...
                        GeneratedField::DenomMetadata => {
                            if denom_metadata__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("denomMetadata"),
                                );
                            }
                        ...
                        GeneratedField::SendEnabled => {
                            if send_enabled__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("sendEnabled"),
                                );
                            }
...
impl serde::Serialize for Input {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Input", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.coins.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Input {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Input", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Metadata {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Metadata", len)?;
        if !self.description.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Metadata {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Metadata", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgMultiSend {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgMultiSend", len)?;
        if !self.inputs.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgMultiSend, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgMultiSendResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgMultiSendResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgSend {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgSend", len)?;
        if !self.from_address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgSend {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.MsgSend", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgSendResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgSendResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgSendResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
...
impl serde::Serialize for MsgSetSendEnabled {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgSetSendEnabled", len)?;
        if !self.authority.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgSetSendEnabled, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::UseDefaultFor => {
                            if use_default_for__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("useDefaultFor"),
                                );
                            }
...
impl serde::Serialize for MsgSetSendEnabledResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgSetSendEnabledResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.MsgSetSendEnabledResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for MsgUpdateParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgUpdateParams", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if let Some(v) = self.params.as_ref() {
...
impl serde::Serialize for MsgUpdateParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.MsgUpdateParamsResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for Output {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Output", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.coins.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Output {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Output", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Params", len)?;
        if !self.send_enabled.is_empty() {
            struct_ser.serialize_field("sendEnabled", &self.send_enabled)?;
        }
        if self.default_send_enabled {
            struct_ser
                .serialize_field("defaultSendEnabled", &self.default_send_enabled)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Params {
        ...
        D: serde::Deserializer<'de>,
    {
                    ...
                    match k {
                        ...
                        GeneratedField::DefaultSendEnabled => {
                            if default_send_enabled__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("defaultSendEnabled"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Params", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAllBalancesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryAllBalancesRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
...
impl serde::Serialize for QueryAllBalancesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryAllBalancesResponse", len)?;
        if !self.balances.is_empty() {
            struct_ser.serialize_field("balances", &self.balances)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryAllBalancesResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryBalanceRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryBalanceRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.denom.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryBalanceRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
...
impl serde::Serialize for QueryBalanceResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryBalanceResponse", len)?;
        if let Some(v) = self.balance.as_ref() {
            struct_ser.serialize_field("balance", v)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryDenomMetadataRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomMetadataRequest", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryDenomMetadataRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryDenomMetadataResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomMetadataResponse", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryDenomMetadataResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryDenomOwnersRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomOwnersRequest", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl serde::Serialize for QueryDenomOwnersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomOwnersResponse", len)?;
        if !self.denom_owners.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "denomOwners" | "denom_owners" => {
                                Ok(GeneratedField::DenomOwners)
                            }
                            "pagination" => Ok(GeneratedField::Pagination),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryDenomOwnersResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        GeneratedField::DenomOwners => {
                            if denom_owners__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("denomOwners"),
                                );
                            }
...
impl serde::Serialize for QueryDenomsMetadataRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomsMetadataRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryDenomsMetadataRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryDenomsMetadataResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryDenomsMetadataResponse", len)?;
        if !self.metadatas.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryDenomsMetadataResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryParamsRequest", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryParamsResponse", len)?;
        if let Some(v) = self.params.as_ref() {
            struct_ser.serialize_field("params", v)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QuerySendEnabledRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QuerySendEnabledRequest", len)?;
        if !self.denoms.is_empty() {
...
impl serde::Serialize for QuerySendEnabledResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QuerySendEnabledResponse", len)?;
        if !self.send_enabled.is_empty() {
            struct_ser.serialize_field("sendEnabled", &self.send_enabled)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QuerySendEnabledResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.bank.v1beta1.QuerySpendableBalanceByDenomRequest",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.bank.v1beta1.QuerySpendableBalanceByDenomResponse",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.bank.v1beta1.QuerySpendableBalancesRequest",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.bank.v1beta1.QuerySpendableBalancesResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for QuerySupplyOfRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QuerySupplyOfRequest", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QuerySupplyOfResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QuerySupplyOfResponse", len)?;
...
impl serde::Serialize for QueryTotalSupplyRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryTotalSupplyRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryTotalSupplyResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.QueryTotalSupplyResponse", len)?;
        if !self.supply.is_empty() {
            struct_ser.serialize_field("supply", &self.supply)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.bank.v1beta1.QueryTotalSupplyResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for SendAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.SendAuthorization", len)?;
        if !self.spend_limit.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<SendAuthorization, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for SendEnabled {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.SendEnabled", len)?;
        if !self.denom.is_empty() {
            struct_ser.serialize_field("denom", &self.denom)?;
        }
        if self.enabled {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<SendEnabled, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut denom__ = None;
...
impl serde::Serialize for Supply {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.bank.v1beta1.Supply", len)?;
        if !self.total.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Supply {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmos.bank.v1beta1.Supply", FIELDS, GeneratedVisitor)
    }
}
