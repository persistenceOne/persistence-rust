impl serde::Serialize for AllowedMsgAllowance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.AllowedMsgAllowance", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<AllowedMsgAllowance, V::Error>
            where
                    ...
                    match k {
                        ...
                        GeneratedField::AllowedMessages => {
                            if allowed_messages__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("allowedMessages"),
                                );
                            }
...
impl serde::Serialize for BasicAllowance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.BasicAllowance", len)?;
        if !self.spend_limit.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<BasicAllowance, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.GenesisState", len)?;
        if !self.allowances.is_empty() {
...
impl serde::Serialize for Grant {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.Grant", len)?;
        if !self.granter.is_empty() {
...
impl serde::Serialize for MsgGrantAllowance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.MsgGrantAllowance", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgGrantAllowance, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut granter__ = None;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for MsgRevokeAllowance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.MsgRevokeAllowance", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgRevokeAllowance, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut granter__ = None;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for PeriodicAllowance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.PeriodicAllowance", len)?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<PeriodicAllowance, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::PeriodSpendLimit => {
                            if period_spend_limit__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("periodSpendLimit"),
                                );
                            }
                        ...
                        GeneratedField::PeriodCanSpend => {
                            if period_can_spend__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("periodCanSpend"),
                                );
                            }
                        ...
                        GeneratedField::PeriodReset => {
                            if period_reset__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("periodReset"),
                                );
                            }
...
impl serde::Serialize for QueryAllowanceRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.QueryAllowanceRequest", len)?;
        if !self.granter.is_empty() {
            struct_ser.serialize_field("granter", &self.granter)?;
        }
        if !self.grantee.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.feegrant.v1beta1.QueryAllowanceRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryAllowanceResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.QueryAllowanceResponse", len)?;
        if let Some(v) = self.allowance.as_ref() {
            struct_ser.serialize_field("allowance", v)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.feegrant.v1beta1.QueryAllowanceResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.feegrant.v1beta1.QueryAllowancesByGranterRequest",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for QueryAllowancesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.QueryAllowancesRequest", len)?;
        if !self.grantee.is_empty() {
            struct_ser.serialize_field("grantee", &self.grantee)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.feegrant.v1beta1.QueryAllowancesRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryAllowancesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmos.feegrant.v1beta1.QueryAllowancesResponse", len)?;
        if !self.allowances.is_empty() {
            struct_ser.serialize_field("allowances", &self.allowances)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmos.feegrant.v1beta1.QueryAllowancesResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
