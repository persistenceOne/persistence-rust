...
#[proto_message(type_url = "/cosmos.distribution.v1beta1.TokenizeShareRecordReward")]
...
#[proto_message(type_url = "/cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardRequest")]
#[proto_query(
    path = "/cosmos.distribution.v1beta1.Query/TokenizeShareRecordReward",
    response_type = QueryTokenizeShareRecordRewardResponse
)]
...
#[proto_message(type_url = "/cosmos.distribution.v1beta1.QueryTokenizeShareRecordRewardResponse")]
...
#[proto_message(type_url = "/cosmos.distribution.v1beta1.MsgWithdrawTokenizeShareRecordReward")]
...
#[proto_message(
    type_url = "/cosmos.distribution.v1beta1.MsgWithdrawTokenizeShareRecordRewardResponse"
)]
...
#[proto_message(type_url = "/cosmos.distribution.v1beta1.MsgWithdrawAllTokenizeShareRecordReward")]
...
#[proto_message(
    type_url = "/cosmos.distribution.v1beta1.MsgWithdrawAllTokenizeShareRecordRewardResponse"
)]
...
impl<'a, Q: cosmwasm_std::CustomQuery> DistributionQuerier<'a, Q> {
    ...
    pub fn tokenize_share_record_reward(
        &self,
        owner_address: ::prost::alloc::string::String,
    ) -> Result<QueryTokenizeShareRecordRewardResponse, cosmwasm_std::StdError> {
        QueryTokenizeShareRecordRewardRequest { owner_address }.query(self.querier)
    }
}
