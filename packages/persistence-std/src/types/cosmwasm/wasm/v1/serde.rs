...
impl serde::Serialize for AbsoluteTxPosition {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AbsoluteTxPosition", len)?;
        if self.block_height != 0 {
            struct_ser
                .serialize_field(
                    "blockHeight",
        ...
        if self.tx_index != 0 {
            struct_ser
                .serialize_field(
                    "txIndex",
                    ToString::to_string(&self.tx_index).as_str(),
                )?;
        }
        struct_ser.end()
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<AbsoluteTxPosition, V::Error>
            where
...
impl serde::Serialize for AcceptedMessageKeysFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AcceptedMessageKeysFilter", len)?;
        if !self.keys.is_empty() {
...
impl serde::Serialize for AcceptedMessagesFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AcceptedMessagesFilter", len)?;
        if !self.messages.is_empty() {
            struct_ser
                .serialize_field(
                    "messages",
                    ...
                    match k {
                        GeneratedField::Messages => {
                            ...
                            messages__ = Some(
                                map
                                    .next_value::<
                                        Vec<::pbjson::private::BytesDeserialize<_>>,
                                    >()?
                                    .into_iter()
                                    .map(|x| x.0)
                                    .collect(),
...
impl serde::Serialize for AccessConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AccessConfig", len)?;
        if self.permission != 0 {
            let v = AccessType::from_i32(self.permission)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.permission),
                ))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<AccessConfig, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for AccessConfigUpdate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AccessConfigUpdate", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<AccessConfigUpdate, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        ...
                        GeneratedField::InstantiatePermission => {
                            if instantiate_permission__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("instantiatePermission"),
                                );
                            }
...
impl serde::Serialize for AccessTypeParam {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AccessTypeParam", len)?;
        if self.value != 0 {
            let v = AccessType::from_i32(self.value)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.value),
                ))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<AccessTypeParam, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for AllowAllMessagesFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.AllowAllMessagesFilter", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for ClearAdminProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ClearAdminProposal", len)?;
        if !self.title.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ClearAdminProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl<'de> serde::Deserialize<'de> for Code {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.Code", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CodeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.CodeInfo", len)?;
        if !self.code_hash.is_empty() {
            struct_ser
                .serialize_field(
                    "codeHash",
...
impl<'de> serde::Deserialize<'de> for CodeInfo {
        ...
        D: serde::Deserializer<'de>,
    {
                    ...
                    match k {
                        ...
                        GeneratedField::InstantiateConfig => {
                            if instantiate_config__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("instantiateConfig"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.CodeInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CodeInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.CodeInfoResponse", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<CodeInfoResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut code_id__ = None;
...
impl serde::Serialize for CombinedLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.CombinedLimit", len)?;
        if self.calls_remaining != 0 {
            struct_ser
                .serialize_field(
                    "callsRemaining",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<CombinedLimit, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                    ...
                    match k {
                        GeneratedField::CallsRemaining => {
                            if calls_remaining__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("callsRemaining"),
                                );
                            }
...
impl serde::Serialize for Contract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.Contract", len)?;
        if !self.contract_address.is_empty() {
        ...
        if !self.contract_code_history.is_empty() {
            struct_ser
                .serialize_field("contractCodeHistory", &self.contract_code_history)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Contract {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "contractInfo" | "contract_info" => {
                                Ok(GeneratedField::ContractInfo)
                            }
                            "contractState" | "contract_state" => {
                                Ok(GeneratedField::ContractState)
                            }
                    ...
                    match k {
                        GeneratedField::ContractAddress => {
                            if contract_address__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("contractAddress"),
                                );
                            }
                        ...
                        GeneratedField::ContractInfo => {
                            if contract_info__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("contractInfo"),
                                );
                            }
                        ...
                        GeneratedField::ContractState => {
                            if contract_state__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("contractState"),
                                );
                            }
                        ...
                        GeneratedField::ContractCodeHistory => {
                            if contract_code_history__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("contractCodeHistory"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.Contract", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ContractCodeHistoryEntry {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ContractCodeHistoryEntry", len)?;
        if self.operation != 0 {
            let v = ContractCodeHistoryOperationType::from_i32(self.operation)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.operation),
                ))?;
        ...
        if !self.msg.is_empty() {
            struct_ser
                .serialize_field(
                    "msg",
                    pbjson::private::base64::encode(&self.msg).as_str(),
                )?;
        }
        struct_ser.end()
    }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Operation => {
                            ...
                            operation__ = Some(
                                map.next_value::<ContractCodeHistoryOperationType>()? as i32,
                            );
                        }
                        GeneratedField::CodeId => {
                            if code_id__.is_some() {
...
impl serde::Serialize for ContractExecutionAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ContractExecutionAuthorization", len)?;
        if !self.grants.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.ContractExecutionAuthorization")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for ContractGrant {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ContractGrant", len)?;
        if !self.contract.is_empty() {
            struct_ser.serialize_field("contract", &self.contract)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ContractGrant, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut contract__ = None;
...
impl serde::Serialize for ContractInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ContractInfo", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<ContractInfo, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut code_id__ = None;
...
impl serde::Serialize for ContractMigrationAuthorization {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ContractMigrationAuthorization", len)?;
        if !self.grants.is_empty() {
            struct_ser.serialize_field("grants", &self.grants)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.ContractMigrationAuthorization")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for ExecuteContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.ExecuteContractProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.GenesisState", len)?;
...
impl serde::Serialize for InstantiateContract2Proposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.InstantiateContract2Proposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        if !self.salt.is_empty() {
            struct_ser
                .serialize_field(
                    "salt",
                    pbjson::private::base64::encode(&self.salt).as_str(),
                )?;
        }
        if self.fix_msg {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.InstantiateContract2Proposal")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for InstantiateContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.InstantiateContractProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.InstantiateContractProposal")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for MaxCallsLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MaxCallsLimit", len)?;
        if self.remaining != 0 {
            struct_ser
                .serialize_field(
                    "remaining",
                    ToString::to_string(&self.remaining).as_str(),
                )?;
        }
        struct_ser.end()
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MaxCallsLimit, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MaxFundsLimit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MaxFundsLimit", len)?;
        if !self.amounts.is_empty() {
            struct_ser.serialize_field("amounts", &self.amounts)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MaxFundsLimit, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut amounts__ = None;
...
impl serde::Serialize for MigrateContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MigrateContractProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.key.is_empty() {
            struct_ser
                .serialize_field(
                    "key",
                    pbjson::private::base64::encode(&self.key).as_str(),
                )?;
        }
        if !self.value.is_empty() {
            struct_ser
...
impl<'de> serde::Deserialize<'de> for Model {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.Model", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgAddCodeUploadParamsAddresses {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgAddCodeUploadParamsAddresses", len)?;
        if !self.authority.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.MsgAddCodeUploadParamsAddresses")
            }
            fn visit_map<V>(
                self,
                mut map: V,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.MsgAddCodeUploadParamsAddressesResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for MsgClearAdmin {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgClearAdmin", len)?;
        if !self.sender.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgClearAdmin, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgClearAdminResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgClearAdminResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgExecuteContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgExecuteContract", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.contract.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgExecuteContract, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::Msg => {
                            ...
                            let msg = serde_json_wasm::to_string(&value).unwrap();
                            // println!("msg: {}", msg);
                            msg__ = Some(msg.as_bytes().to_vec());
...
impl serde::Serialize for MsgExecuteContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgExecuteContractResponse", len)?;
        if !self.data.is_empty() {
            struct_ser
                .serialize_field(
                    "data",
                    pbjson::private::base64::encode(&self.data).as_str(),
                )?;
        }
        struct_ser.end()
    }
...
impl serde::Serialize for MsgIbcCloseChannel {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgIBCCloseChannel", len)?;
        if !self.channel.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgIbcCloseChannel, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgIbcSend {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgIBCSend", len)?;
        if !self.channel.is_empty() {
            struct_ser.serialize_field("channel", &self.channel)?;
        }
        if self.timeout_height != 0 {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "timeoutHeight" | "timeout_height" => {
                                Ok(GeneratedField::TimeoutHeight)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgIbcSend, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut channel__ = None;
                    ...
                    match k {
                        ...
                        GeneratedField::TimeoutHeight => {
                            if timeout_height__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("timeoutHeight"),
                                );
                            }
                        ...
                        GeneratedField::TimeoutTimestamp => {
                            if timeout_timestamp__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("timeoutTimestamp"),
                                );
                            }
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.MsgIBCSend", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgIbcSendResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgIBCSendResponse", len)?;
        if self.sequence != 0 {
            struct_ser
                .serialize_field(
                    "sequence",
                    ToString::to_string(&self.sequence).as_str(),
                )?;
        }
        struct_ser.end()
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgIbcSendResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for MsgInstantiateContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.admin.is_empty() {
...
impl serde::Serialize for MsgInstantiateContract2 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.admin.is_empty() {
...
impl serde::Serialize for MsgInstantiateContract2Response {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContract2Response", len)?;
        if !self.address.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.MsgInstantiateContract2Response")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for MsgInstantiateContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgInstantiateContractResponse", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.data.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.MsgInstantiateContractResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for MsgMigrateContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgMigrateContract", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.contract.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgMigrateContract, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
...
impl serde::Serialize for MsgMigrateContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgMigrateContractResponse", len)?;
        if !self.data.is_empty() {
            struct_ser
                .serialize_field(
                    "data",
...
impl serde::Serialize for MsgPinCodes {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgPinCodes", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.code_ids.is_empty() {
            struct_ser
                .serialize_field(
                    "codeIds",
                    &self.code_ids.iter().map(ToString::to_string).collect::<Vec<_>>(),
                )?;
        }
        struct_ser.end()
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgPinCodes, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut authority__ = None;
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.MsgPinCodes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgPinCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgPinCodesResponse", len)?;
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgPinCodesResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                while map.next_key::<GeneratedField>()?.is_some() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.MsgRemoveCodeUploadParamsAddresses",
                    )
            }
            fn visit_map<V>(
                self,
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.MsgRemoveCodeUploadParamsAddressesResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for MsgStoreAndInstantiateContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgStoreAndInstantiateContract", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.wasm_byte_code.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "wasmByteCode" | "wasm_byte_code" => {
                                Ok(GeneratedField::WasmByteCode)
                            }
                            "instantiatePermission" | "instantiate_permission" => {
                                Ok(GeneratedField::InstantiatePermission)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.MsgStoreAndInstantiateContract")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        ...
                        GeneratedField::WasmByteCode => {
                            if wasm_byte_code__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("wasmByteCode"),
                                );
                            }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.MsgStoreAndInstantiateContractResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for MsgStoreCode {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgStoreCode", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.wasm_byte_code.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgStoreCode, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
...
impl serde::Serialize for MsgStoreCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgStoreCodeResponse", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
...
impl serde::Serialize for MsgSudoContract {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgSudoContract", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.contract.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgSudoContract, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut authority__ = None;
...
impl serde::Serialize for MsgSudoContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgSudoContractResponse", len)?;
        if !self.data.is_empty() {
            struct_ser
                .serialize_field(
                    "data",
...
impl serde::Serialize for MsgUnpinCodes {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUnpinCodes", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.code_ids.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgUnpinCodes, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut authority__ = None;
...
impl serde::Serialize for MsgUnpinCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUnpinCodesResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgUpdateAdmin {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUpdateAdmin", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.new_admin.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<MsgUpdateAdmin, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
...
impl serde::Serialize for MsgUpdateAdminResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUpdateAdminResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for MsgUpdateInstantiateConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUpdateInstantiateConfig", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if self.code_id != 0 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.MsgUpdateInstantiateConfigResponse",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for MsgUpdateParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUpdateParams", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if let Some(v) = self.params.as_ref() {
...
impl serde::Serialize for MsgUpdateParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.MsgUpdateParamsResponse", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.Params", len)?;
        if let Some(v) = self.code_upload_access.as_ref() {
            struct_ser.serialize_field("codeUploadAccess", v)?;
        }
        if self.instantiate_default_permission != 0 {
            let v = AccessType::from_i32(self.instantiate_default_permission)
                .ok_or_else(|| serde::ser::Error::custom(
                    format!("Invalid variant {}", self.instantiate_default_permission),
                ))?;
...
impl<'de> serde::Deserialize<'de> for Params {
        ...
        D: serde::Deserializer<'de>,
    {
                    ...
                    match k {
                        GeneratedField::CodeUploadAccess => {
                            if code_upload_access__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("codeUploadAccess"),
                                );
                            }
                        ...
                        GeneratedField::InstantiateDefaultPermission => {
                            ...
                            instantiate_default_permission__ = Some(
                                map.next_value::<AccessType>()? as i32,
                            );
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map.next_value::<serde::de::IgnoredAny>()?;
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.Params", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PinCodesProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.PinCodesProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<PinCodesProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
...
impl serde::Serialize for QueryAllContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryAllContractStateRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryAllContractStateRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryAllContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryAllContractStateResponse", len)?;
        if !self.models.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryAllContractStateResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryCodeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryCodeRequest", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryCodeRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut code_id__ = None;
...
impl serde::Serialize for QueryCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryCodeResponse", len)?;
        if let Some(v) = self.code_info.as_ref() {
            struct_ser.serialize_field("codeInfo", v)?;
        }
        if !self.data.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryCodeResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut code_info__ = None;
...
impl serde::Serialize for QueryCodesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryCodesRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryCodesRequest, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut pagination__ = None;
...
impl serde::Serialize for QueryCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryCodesResponse", len)?;
        if !self.code_infos.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<QueryCodesResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for QueryContractHistoryRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractHistoryRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractHistoryRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryContractHistoryResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractHistoryResponse", len)?;
        if !self.entries.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractHistoryResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryContractInfoRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractInfoRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryContractInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractInfoResponse", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if let Some(v) = self.contract_info.as_ref() {
...
impl serde::Serialize for QueryContractsByCodeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeRequest", len)?;
        if self.code_id != 0 {
            struct_ser
                .serialize_field("codeId", ToString::to_string(&self.code_id).as_str())?;
        }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractsByCodeRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryContractsByCodeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractsByCodeResponse", len)?;
        if !self.contracts.is_empty() {
            struct_ser.serialize_field("contracts", &self.contracts)?;
        }
        if let Some(v) = self.pagination.as_ref() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractsByCodeResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryContractsByCreatorRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractsByCreatorRequest", len)?;
        if !self.creator_address.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractsByCreatorRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        GeneratedField::CreatorAddress => {
                            if creator_address__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("creatorAddress"),
                                );
                            }
...
impl serde::Serialize for QueryContractsByCreatorResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryContractsByCreatorResponse", len)?;
        if !self.contract_addresses.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryContractsByCreatorResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        GeneratedField::ContractAddresses => {
                            if contract_addresses__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("contractAddresses"),
                                );
                            }
...
impl serde::Serialize for QueryParamsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryParamsRequest", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for QueryParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryParamsResponse", len)?;
        if let Some(v) = self.params.as_ref() {
            struct_ser.serialize_field("params", v)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryPinnedCodesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesRequest", len)?;
        if let Some(v) = self.pagination.as_ref() {
            struct_ser.serialize_field("pagination", v)?;
        }
        struct_ser.end()
...
impl serde::Serialize for QueryPinnedCodesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryPinnedCodesResponse", len)?;
        if !self.code_ids.is_empty() {
            struct_ser
                .serialize_field(
                    "codeIds",
...
impl serde::Serialize for QueryRawContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryRawContractStateRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.query_data.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryRawContractStateRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QueryRawContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QueryRawContractStateResponse", len)?;
        if !self.data.is_empty() {
            struct_ser
                .serialize_field(
                    "data",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QueryRawContractStateResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QuerySmartContractStateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateRequest", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.query_data.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QuerySmartContractStateRequest")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for QuerySmartContractStateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.QuerySmartContractStateResponse", len)?;
        if !self.data.is_empty() {
            struct_ser
                .serialize_field(
                    "data",
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.QuerySmartContractStateResponse")
            }
            fn visit_map<V>(
                self,
                mut map: V,
...
impl serde::Serialize for Sequence {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.Sequence", len)?;
        if !self.id_key.is_empty() {
            struct_ser
                .serialize_field(
                    "idKey",
        ...
        if self.value != 0 {
            struct_ser
                .serialize_field("value", ToString::to_string(&self.value).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Sequence {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer
            .deserialize_struct("cosmwasm.wasm.v1.Sequence", FIELDS, GeneratedVisitor)
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str(
                        "struct cosmwasm.wasm.v1.StoreAndInstantiateContractProposal",
                    )
            }
            fn visit_map<V>(
                self,
...
impl serde::Serialize for StoreCodeProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.StoreCodeProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<StoreCodeProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
...
impl serde::Serialize for SudoContractProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.SudoContractProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
...
impl serde::Serialize for UnpinCodesProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.UnpinCodesProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<UnpinCodesProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
...
impl serde::Serialize for UpdateAdminProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.UpdateAdminProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(
                self,
                mut map: V,
            ) -> std::result::Result<UpdateAdminProposal, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut title__ = None;
...
impl serde::Serialize for UpdateInstantiateConfigProposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer
            .serialize_struct("cosmwasm.wasm.v1.UpdateInstantiateConfigProposal", len)?;
        if !self.title.is_empty() {
            struct_ser.serialize_field("title", &self.title)?;
        }
        if !self.description.is_empty() {
        ...
        if !self.access_config_updates.is_empty() {
            struct_ser
                .serialize_field("accessConfigUpdates", &self.access_config_updates)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(
                ...
                formatter
                    .write_str("struct cosmwasm.wasm.v1.UpdateInstantiateConfigProposal")
            }
            fn visit_map<V>(
                self,
                mut map: V,
                    ...
                    match k {
                        ...
                        GeneratedField::AccessConfigUpdates => {
                            if access_config_updates__.is_some() {
                                return Err(
                                    serde::de::Error::duplicate_field("accessConfigUpdates"),
                                );
                            }
