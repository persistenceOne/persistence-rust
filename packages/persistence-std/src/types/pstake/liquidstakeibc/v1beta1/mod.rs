...
pub struct Unbonding {
    ...
    pub burn_amount: ::core::option::Option<
        super::super::super::cosmos::base::v1beta1::Coin,
    >,
    /// host token amount that is being unbonded
    #[prost(message, optional, tag = "5")]
    pub unbond_amount: ::core::option::Option<
        super::super::super::cosmos::base::v1beta1::Coin,
    >,
    /// sequence id of the ibc transaction
    #[prost(string, tag = "6")]
...
pub struct UserUnbonding {
    ...
    #[prost(message, optional, tag = "4")]
    pub stk_amount: ::core::option::Option<
        super::super::super::cosmos::base::v1beta1::Coin,
    >,
    /// host token amount that is being unbonded
    #[prost(message, optional, tag = "5")]
...
#[derive(::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/pstake.liquidstakeibc.v1beta1.MsgRegisterHostChainResponse"
)]
...
#[derive(::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/pstake.liquidstakeibc.v1beta1.QueryValidatorUnbondingRequest"
)]
#[proto_query(
...
#[derive(::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/pstake.liquidstakeibc.v1beta1.QueryValidatorUnbondingResponse"
)]
...
#[derive(::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/pstake.liquidstakeibc.v1beta1.QueryDepositAccountBalanceRequest"
)]
#[proto_query(
...
#[derive(::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(
    type_url = "/pstake.liquidstakeibc.v1beta1.QueryDepositAccountBalanceResponse"
)]
...
impl<'a, Q: cosmwasm_std::CustomQuery> LiquidstakeibcQuerier<'a, Q> {
    ...
    pub fn host_chains(
        &self,
    ) -> Result<QueryHostChainsResponse, cosmwasm_std::StdError> {
