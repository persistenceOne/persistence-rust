...
pub struct DelegationState {
    ...
    #[prost(message, repeated, tag = "1")]
    pub host_delegation_account_balance:
...
pub struct IbcAmountTransientStore {
    ...
    #[prost(message, repeated, tag = "1")]
    pub i_b_c_transfer: ::prost::alloc::vec::Vec<super::super::super::cosmos::base::v1beta1::Coin>,
    /// ica_delegate stores only token which has staking baseDenom
    #[prost(message, optional, tag = "2")]
    pub i_c_a_delegate: ::core::option::Option<super::super::super::cosmos::base::v1beta1::Coin>,
    #[prost(message, repeated, tag = "3")]
    pub undelegaton_complete_i_b_c_transfer:
        ::prost::alloc::vec::Vec<TransientUndelegationTransfer>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(
    Clone,
...
pub struct TransientUndelegationTransfer {
    ...
    pub epoch_number: i64,
    #[prost(message, optional, tag = "2")]
    pub amount_unbonded: ::core::option::Option<super::super::super::cosmos::base::v1beta1::Coin>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(
    Clone,
...
pub struct UnbondingEpochCValue {
    ...
    #[prost(message, optional, tag = "2")]
    pub s_t_k_burn: ::core::option::Option<super::super::super::cosmos::base::v1beta1::Coin>,
    #[prost(message, optional, tag = "3")]
    pub amount_unbonded: ::core::option::Option<super::super::super::cosmos::base::v1beta1::Coin>,
    #[prost(bool, tag = "4")]
    pub is_matured: bool,
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.AllowListedValidatorSetChangeProposal")]
#[deprecated]
...
pub struct GenesisState {
    ...
    pub delegator_unbonding_epoch_entries: ::prost::alloc::vec::Vec<DelegatorUnbondingEpochEntry>,
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.QueryAllowListedValidatorsResponse")]
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.QueryHostAccountUndelegationRequest")]
#[proto_query(
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.QueryHostAccountUndelegationResponse")]
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.QueryDelegatorUnbondingEpochEntryRequest")]
#[proto_query(
...
#[proto_message(type_url = "/pstake.lscosmos.v1beta1.QueryDelegatorUnbondingEpochEntryResponse")]
pub struct QueryDelegatorUnbondingEpochEntryResponse {
    #[prost(message, optional, tag = "1")]
    pub delegator_unboding_epoch_entry: ::core::option::Option<DelegatorUnbondingEpochEntry>,
}
...
impl<'a, Q: cosmwasm_std::CustomQuery> LscosmosQuerier<'a, Q> {
    ...
    pub fn delegation_state(&self) -> Result<QueryDelegationStateResponse, cosmwasm_std::StdError> {
    ...
    pub fn allow_listed_validators(
        ...
        QueryAllowListedValidatorsRequest {}.query(self.querier)
    }
    pub fn c_value(&self) -> Result<QueryCValueResponse, cosmwasm_std::StdError> {
        QueryCValueRequest {}.query(self.querier)
    }
    pub fn module_state(&self) -> Result<QueryModuleStateResponse, cosmwasm_std::StdError> {
    ...
    pub fn host_accounts(&self) -> Result<QueryHostAccountsResponse, cosmwasm_std::StdError> {
    ...
    pub fn deposit_module_account(
        ...
        QueryDepositModuleAccountRequest {}.query(self.querier)
    }
    pub fn delegator_unbonding_epoch_entries(
        &self,
        delegator_address: ::prost::alloc::string::String,
    ) -> Result<QueryAllDelegatorUnbondingEpochEntriesResponse, cosmwasm_std::StdError> {
        QueryAllDelegatorUnbondingEpochEntriesRequest { delegator_address }.query(self.querier)
    }
}
