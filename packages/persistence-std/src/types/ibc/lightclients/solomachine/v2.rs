...
pub struct SignatureAndData {
    ...
    #[serde(
        serialize_with = "data_type_serde::serialize",
        deserialize_with = "data_type_serde::deserialize"
    )]
    pub data_type: i32,
    #[prost(bytes = "vec", tag = "3")]
...
pub mod data_type_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        let enum_value = DataType::from_str_name(&s).unwrap();
    ...
    where
        S: Serializer,
    {
        let s: DataType = DataType::from_i32(*value).unwrap();
