...
pub struct InterchainAccountPacketData {
    ...
    #[serde(
        serialize_with = "type_serde::serialize",
        deserialize_with = "type_serde::deserialize"
    )]
    pub r#type: i32,
...
pub mod type_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        let enum_value = Type::from_str_name(&s).unwrap();
    ...
    where
        S: Serializer,
    {
        let s: Type = Type::from_i32(*value).unwrap();
